 ...
 * @package flatsome
 */
/* zig:  add option to not display thumbnail based on custom field hide_featured_image */
global $flatsome_opt;
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( has_post_thumbnail() && get_post_meta($post->ID, 'hide_featured_image', true) != 'true')   { // check if the post has a Post Thumbnail assigned to it. ?>

...
/*
 * mods:  
 *  26Feb15 zig - change suggested price to suggested donation 
 *  27Feb15 zig - remove suggested donation & change test to "name your own price"
*/
...
?>
    <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
        <div class="name_price">
	        <?php /* <h5 itemprop="price" class="price">Suggested Donation: <?php echo $product->get_price_html(); ?></h5> */ ?>
            <p itemprop="name_price price" class="price">
              <label>Donation Amount<?php /*echo get_option('shatner_label', "Name your own price")*/ ?> </label>

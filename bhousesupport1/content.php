 ...
 */
/* mods 
	1Apr2016 zig - in blog-list-syle & no featured image, use 12 columns for content 
	10May15 zig - remove date block over thumbnail image on blogliststyle
*/
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="large-4 columns">
        <div class="entry-image">
           ...
           <?php /* zig xout <div class="post-date large">
	                <span class="post-date-day"><?php echo get_the_time('d', get_the_ID()); ?></span>
	                <span class="post-date-month"><?php echo get_the_time('M', get_the_ID()); ?></span>
            </div> */ ?>
        </div>
	...
	<div class="large-8 columns">   <?php /* zig - added */ ?>
    <?php } else { /* zig - added */  ?>
    	<div class="large-12 columns"> <?php /* zig - added */ ?>
    <?php }  /* zig - added */  ?>	
	<?php /* <div class="large-8 columns"> */ /* zig  - commented out*/ ?>

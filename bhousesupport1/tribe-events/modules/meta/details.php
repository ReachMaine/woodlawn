 ...
 */
/* 
	zig 12april2016 - dont print start/end or Date in details 
*/ 
...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<dl>
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<?php /* <dt> <?php esc_html_e( 'Start:', 'the-events-calendar' ) ?> </dt> zig xout */ ?> 
			<dd>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<?php /* <dt> <?php esc_html_e( 'Date:', 'the-events-calendar' ) ?> </dt>  zig xout */ ?>
			<dd>
				<abbr class="tribe-events-abbr updated published dtstart" title="<?php esc_attr_e( $start_ts ) ?>"> <?php esc_html_e( $start_date ) ?> </abbr>
			</dd>
		...
		// Single day events
			...
			<?php /* <dt> <?php echo esc_html( $time_title ); ?> </dt> zig xout */ ?>
